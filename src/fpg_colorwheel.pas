...
type
  ...
  protected
    ...
    FHue: longint;
    FBorder: boolean; // to draw a black circle around colorwheel
    FSaturation: double;
    ...
    procedure   SetBorder(NewBorder: boolean); // to draw a black circle around colorwheel
...
begin
  ...
  begin
    ...
    // draw border-circle // to draw a black circle around colorwheel
...
procedure  TfpgColorWheel.SetBorder(NewBorder: boolean); // to draw a black circle around colorwheel
begin
FBorder := NewBorder;
Invalidate;
end;
